...
(function () {
    ...
    function initializeEvents() {
        ...
        // added by tim
        $('#dropperBtnImg').on($axure.eventNames.mouseDownName, function () {
            window.mainFrame.hover_locker = !window.mainFrame.hover_locker
            $('#dropperBtnImg').attr("lock", window.mainFrame.hover_locker)
            if (window.mainFrame.hover_locker) window.mainFrame.closeHoverFn()
        });
