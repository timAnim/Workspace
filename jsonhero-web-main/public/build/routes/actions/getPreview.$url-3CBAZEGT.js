...
// empty-module:~/services/uriPreview.server
var require_uriPreview = __commonJS({
  "empty-module:~/services/uriPreview.server"(exports, module) {
    init_react();
    module.exports = {};
  }
});

// browser-route-module:E:\Workspace\jsonhero-web-main\app\routes\actions\getPreview.$url.ts?browser
init_react();

// app/routes/actions/getPreview.$url.ts
init_react();
var import_uriPreview = __toESM(require_uriPreview());
var loader = async ({ params }) => {
  try {
    ...
    const result = await (0, import_uriPreview.getUriPreview)(decoded);
    ...
    return new Response(JSON.stringify({ error: "Unable to preview this URL" }), {
      headers: {
        "Content-Type": "application/json; charset=utf-8",
        "Cache-Control": "public, max-age=3600"
      }
...
function earlyRespondIfHomepagePreviewUri(uri) {
...
//# sourceMappingURL=/build/routes/actions/getPreview.$url-3CBAZEGT.js.map
