...
var require_json_source_map = __commonJS({
  "node_modules/json-source-map/index.js"(exports) {
    "use strict";
    init_react();
    var escapedChars = {
      "b": "\b",
...
var StringQuery = class extends QueryType2 {
  ...
  prevMatchInRange(doc2, from, to) {
    for (let pos = to; ; ) {
      ...
      let cursor2 = this.cursor(doc2, start, pos), range = null;
...
var RegExpQuery = class extends QueryType2 {
  ...
  prevMatchInRange(doc2, from, to) {
    for (let size = 1; ; size++) {
      ...
      let cursor2 = this.cursor(doc2, start, to), range = null;
      while (!cursor2.next().done)
        range = cursor2.value;
...
function useCodeMirror(props) {
  var {
    ...
    indentWithTab: indentWithTab2 = true,
    basicSetup: basicSetup2 = true,
    root
  } = props;
  var [container, setContainer] = (0, import_react.useState)(props.container);
  ...
  if (placeholder2) {
    getExtensions.unshift(placeholder(placeholder2));
  }
  switch (theme2) {
    case "light":
  ...
  }, [theme2, extensions, placeholder2, height, minHeight, maxHeight, width, minWidth, maxWidth, editable2, indentWithTab2, basicSetup2]);
  (0, import_react.useEffect)(() => {
    if (autoFocus && view) {
      view.focus();
    }
...
var ReactCodeMirror = /* @__PURE__ */ import_react2.default.forwardRef((props, ref) => {
  var {
    className,
    value = "",
    selection: selection2,
...
init_react();
function darkTheme2() {
  const chalky2 = "#e5c07b", coral2 = "#e06c75", cyan2 = "#56b6c2", invalid2 = "#ffffff", ivory2 = "#abb2bf", stone2 = "#7d8799", malibu2 = "#61afef", sage2 = "#98c379", whiskey2 = "#d19a66", violet2 = "#c678dd", darkBackground2 = "#21252b", highlightBackground2 = "rgba(234,179,8,0.3)", background2 = "rgb(15,23,42)", tooltipBackground2 = "#353a42", selection2 = "#3E4451", cursor2 = "#528bff";
  const jsonHeroEditorTheme = EditorView.theme({
    ...
    ".cm-panels": { backgroundColor: darkBackground2, color: ivory2 },
    ".cm-panels.cm-panels-top": { borderBottom: "2px solid black" },
    ".cm-panels.cm-panels-bottom": { borderTop: "2px solid black" },
    ".cm-searchMatch": {
      backgroundColor: "#72a1ff59",
  ...
  const jsonHeroHighlightStyle = HighlightStyle.define([
    { tag: tags.keyword, color: violet2 },
    {
      tag: [tags.name, tags.deleted, tags.character, tags.propertyName, tags.macroName],
      color: coral2
    },
    { tag: [tags.function(tags.variableName), tags.labelName], color: malibu2 },
    { tag: [tags.color, tags.constant(tags.name), tags.standard(tags.name)], color: whiskey2 },
    { tag: [tags.definition(tags.name), tags.separator], color: ivory2 },
    {
      tag: [
        tags.typeName,
        tags.className,
    ...
    { tag: [tags.meta, tags.comment], color: stone2 },
    { tag: tags.strong, fontWeight: "bold" },
    { tag: tags.emphasis, fontStyle: "italic" },
    { tag: tags.strikethrough, textDecoration: "line-through" },
    { tag: tags.link, color: stone2, textDecoration: "underline" },
    { tag: tags.heading, fontWeight: "bold", color: coral2 },
    { tag: [tags.atom, tags.bool, tags.special(tags.variableName)], color: whiskey2 },
    { tag: [tags.processingInstruction, tags.string, tags.inserted], color: sage2 },
    { tag: tags.invalid, color: invalid2 }
  ]);
  return [jsonHeroEditorTheme, jsonHeroHighlightStyle];
}
function lightTheme() {
  const chalky2 = "#e5c07b", coral2 = "#e06c75", cyan2 = "#56b6c2", invalid2 = "#ffffff", ivory2 = "#abb2bf", stone2 = "#7d8799", malibu2 = "#61afef", sage2 = "#98c379", whiskey2 = "#d19a66", violet2 = "#c678dd", darkBackground2 = "#21252b", highlightBackground2 = "#D0D0D0", background2 = "rgb(248,250,252)", tooltipBackground2 = "#353a42", selection2 = "#D0D0D0", cursor2 = "#528bff";
  const jsonHeroEditorTheme = EditorView.theme({
    "&": {
      color: ivory2,
      backgroundColor: background2
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-MUQ2Q3OY.js.map
