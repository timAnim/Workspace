...
// app/components/Icons/EmailIconTransparent.tsx
init_react();
function EmailIconTransparent(props) {
...
// app/components/Home/HomeHeader.tsx
function HomeHeader({ fixed }) {
  return /* @__PURE__ */ React.createElement("header", {
    className: `${fixed ? "fixed" : ""} z-20 flex h-12 justify-center  bg-indigo-700 flex-col`
  }, /* @__PURE__ */ React.createElement("div", {
    className: "flex items-center justify-between w-screen px-4"
  }, /* @__PURE__ */ React.createElement("div", {
    className: "flex gap-1 sm:gap-1.5 h-8 justify-center items-center"
  }, /* @__PURE__ */ React.createElement("div", {
    ...
    className: "pt-0.5 w-16 sm:w-24 opacity-80 hover:opacity-100 transition duration-300"
  })), /* @__PURE__ */ React.createElement("ol", {
    className: "flex items-center gap-2 sm:pr-4"
    ...
    className: " bg-lime-400 text-slate-900 text-lg font-bold px-2 py-0.5 rounded uppercase whitespace-nowrap cursor-pointer opacity-90 hover:opacity-100 transition"
  }, "Try now")), /* @__PURE__ */ React.createElement(PopoverContent, {
    side: "bottom",
    sideOffset: 30
    ...
    className: "hover:cursor-pointer opacity-90 hover:opacity-100 transition hidden sm:block"
  }, /* @__PURE__ */ React.createElement("a", {
    href: "mailto:hello@jsonhero.io"
  }, /* @__PURE__ */ React.createElement(EmailIconTransparent, null))), /* @__PURE__ */ React.createElement("li", {
    className: "hover:cursor-pointer opacity-90 hover:opacity-100 transition hidden sm:block"
  }, /* @__PURE__ */ React.createElement("a", {
    href: "https://discord.gg/JtBAxBr2m3",
    target: "_blank"
  }, /* @__PURE__ */ React.createElement(DiscordIconTransparent, null))), /* @__PURE__ */ React.createElement("li", {
    className: "hover:cursor-pointer opacity-90 hover:opacity-100 transition hidden sm:block"
  }, /* @__PURE__ */ React.createElement("a", {
...
//# sourceMappingURL=/build/_shared/chunk-FMOHQYP4.js.map
